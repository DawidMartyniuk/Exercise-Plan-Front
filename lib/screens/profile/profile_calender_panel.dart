...
class _ProfileCalenderState extends ConsumerState<ProfileCalenderPanel> {
  ...
  int _getWorkoutNumberOfConsecutiveWeeks() {
    final sessions = ref.watch(completedTrainingSessionProvider);
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text("Strike weeks: ${_getWorkoutNumberOfConsecutiveWeeks()}",
        ...
        Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: Colors.grey.withAlpha(50), // ✅ ZMIENIONO NA withAlpha
                spreadRadius: 2,
                blurRadius: 5,
              ),
            ],
          ...
          child: CalendarDatePicker2(
            config: CalendarDatePicker2Config(
              ...
              disabledDayTextStyle: TextStyle(
                color: Theme.of(context).colorScheme.onSurface.withAlpha(75), // ✅ ZMIENIONO NA withAlpha
              ),
              ...
              dayBuilder: ({
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: hasTraining 
                      ? Colors.green.withAlpha(178) // ✅ ZMIENIONO NA withAlpha (0.7 * 255 = 178)
                      : ((isSelected != null && isSelected)
                          ? Theme.of(context).colorScheme.primary
                          : ((isToday != null && isToday)
                              ? Theme.of(context).colorScheme.primary.withAlpha(76) // ✅ ZMIENIONO NA withAlpha (0.3 * 255 = 76)
                              : Colors.transparent)),
                    borderRadius: BorderRadius.circular(8),
                    border: hasTraining 
                      ? Border.all(color: Colors.green, width: 2) // ✅ RAMKA
                      : ((isToday != null && isToday)
            ...
            onValueChanged: (dates) {
              ...
              if (dates.isNotEmpty) {
                ...
                Future.delayed(Duration.zero, () {
                  setState(() {
                    _selectedDates = []; // ✅ Wyczyść zaznaczenie po kliknięciu
                  });
                });
              }
            },
        ...
        trainingSessions.isEmpty 
          ? Container(
              ...
              decoration: BoxDecoration(
                color: Theme.of(context).colorScheme.surface.withAlpha(127), // ✅ ZMIENIONO NA withAlpha (0.5 * 255 = 127)
                borderRadius: BorderRadius.circular(12),
              ),
              child: Column(
                children: [
  ...
  TrainingSession? _getTrainingForDate(DateTime date, List<TrainingSession> sessions) {
    try {
      ...
      return null; // Brak treningu w tym dniu
    }
  }
  ...
  // ✅ KARTA TRENINGU - UŻYJ WorkoutCardInfo PO KLIKNIĘCIU
