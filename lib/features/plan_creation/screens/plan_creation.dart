...
import 'package:work_plan_front/features/plan_creation/screens/selected_creation_list.dart';
import 'package:work_plan_front/features/plan_creation/widgets/plan_title_field.dart';
import 'package:work_plan_front/features/plan_creation/widgets/exercise_selection_button.dart';
import 'package:work_plan_front/features/plan_creation/helpers/data_formatter.dart';
...
class _StatePlanCreation extends ConsumerState<PlanCreation> {
  ...
  final GlobalKey<SelectedCreationListState> _selectedExerciseListKey = GlobalKey<SelectedCreationListState>();
  ...
  Widget build(BuildContext context) {
    return KeyboardDismisser(
      child: Scaffold(
        ...
        body: Listener(
                  onPointerMove: (event) {
            SelectedCreationListState.globalPointerDy = event.position.dy;
            SelectedCreationListState.globalAutoScrollCallback?.call();
            
          },
          onPointerUp: (_) {
            SelectedCreationListState.globalPointerDy = null;
            SelectedCreationListState.globalStopAutoScrollCallback?.call();
