...
import 'package:work_plan_front/features/plan_creation/widgets/creation_plan_card_header.dart';
import 'package:work_plan_front/features/workout/components/exercise_ui/exercise_image.dart';
...
class SelectedCreationListState extends ConsumerState<SelectedCreationList> {
  ...
  void initState() {
    ...
    SelectedCreationListState.globalAutoScrollCallback = _startAutoScroll;
    SelectedCreationListState.globalStopAutoScrollCallback = _stopAutoScroll;
...
void dispose() {
  ...
  SelectedCreationListState.globalAutoScrollCallback = null;
  SelectedCreationListState.globalStopAutoScrollCallback = null;
  super.dispose();
}
void _startAutoScroll() {
  ...
  _autoScrollTimer = Timer.periodic(const Duration(milliseconds: 50), (_) {
    ...
    final dy = SelectedCreationListState.globalPointerDy;
    if (dy == null) return;
